        ...
        return NotificationListener<ScrollNotification>(
          onNotification: (notification) {
            if (notification is ScrollEndNotification) {
              BlocProvider.of<RepUnitValueSelectorBloc>(context).add(RepUnitValueSelectorListScrollEnd(_controller, itemHeight));
            }
            if (notification is ScrollUpdateNotification) {
              BlocProvider.of<RepUnitValueSelectorBloc>(context).add(RepUnitValueSelectorListScrollUpdated(_controller, itemHeight));
            }
            ...
            itemBuilder: (context, index) {
              ...
              return AnimatedDefaultTextStyle(
                ...
                style: TextStyle(
                  ...
                  height: 1,
                  fontSize: state.getFontSize(index, itemHeight),
                ),
