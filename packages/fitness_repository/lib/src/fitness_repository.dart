...
///////////////////////////////////////////////////////////////////
  ...
  Future<void> likeWorkout(String workoutId, Like like) async {
    return _fitnessTrackingPlanRef().doc(workoutId).update({WorkoutInfoDocKeys.likes: FieldValue.increment(like.isUp ? 1 : -1)});
  }
